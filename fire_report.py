...
def main(args=[],**kwargs):
	...
	for years in YEAR.split(","):
		try:
			...
			print(f"WARNING [fire_report]: cannot be loaded due to missing data error ({err})",file=sys.stderr)
		except Exception as err:		
			print(f"WARNING [fire_report]: cannot be loaded due to processing error ({err})",file=sys.stderr)
